...
export default function Login() {
  ...
  return (
      <div className="min-h-screen flex dark:bg-surface bg-transparent">

        {/* ── Left panel (desktop) ─────────────────── */}
        <div className="hidden lg:flex lg:w-[45%] flex-col items-center justify-center relative
        overflow-hidden bg-brand-900 dark:bg-[#081312]">

          {/* Animated rings */}
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            {[96, 72, 52].map((size, i) => (
                <div key={i}
                     className="absolute rounded-full border border-brand-400/20 animate-ping-slow"
          ...
          <div className="relative z-10 text-center px-10">
            ...
            bg-brand-400/15 border border-brand-300/30
            flex items-center justify-center backdrop-blur-sm animate-float">
            ...
            <p className="text-brand-200 text-lg mb-10 max-w-xs">
              Your safety, discreet and instant.
            </p>

            <div className="grid grid-cols-2 gap-x-8 gap-y-3 text-sm text-brand-200/80">
