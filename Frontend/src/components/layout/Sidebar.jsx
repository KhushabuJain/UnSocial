...
import {
  ...
  AlertTriangle, MapPin, Timer, LogOut, ShieldCheck, X, Bot
} from 'lucide-react'
...
const navItems = [
  ...
  { icon: Bot,             label: 'AI Safety Assistant',path: '/assistant' },
]
...
export default function Sidebar({ open, onClose }) {
  ...
  return (
      <>
        ...
        border-r dark:border-surface-border border-slate-200/70
      ...
      `}>
          ...
          <div className="flex items-center justify-between px-5 py-5 border-b dark:border-surface-border border-slate-200">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-brand-600 shadow-glow-sm flex items-center justify-center flex-shrink-0">
